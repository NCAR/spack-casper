# Location variables
setenv INSTALLPATH_ROOT /glade/u/apps/casper/25.10-rocm/spack/opt/spack
setenv MODULEPATH_ROOT /glade/u/apps/casper/modules

# Lmod configuration
setenv LMOD_SYSTEM_NAME casper-rocm
setenv LMOD_SYSTEM_DEFAULT_MODULES "ncarenv/25.10-rocm:gcc/14.3.0:ncarcompilers/1.1.0:rocm/6.4.3:openmpi/5.0.9:netcdf/4.9.3"
...
setenv LMOD_PACKAGE_PATH /glade/u/apps/casper/25.10-rocm/envs/public/util
setenv LMOD_CONFIG_DIR /glade/u/apps/casper/25.10-rocm/envs/public/util
setenv LMOD_AVAIL_STYLE grouped:system

# Get location of Lmod initialization scripts
setenv LMOD_ROOT /glade/u/apps/casper/25.10-rocm/spack/opt/spack/lmod/8.7.55/gcc/12.5.0/7u6s
...
setenv NCAR_OS_VERSION `/usr/bin/lsb_release -rs`
...
setenv LMOD_MODULERCFILE /glade/u/apps/casper/25.10-rocm/envs/public/util/hidden-modules
