...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/23.04:intel/2023.0.0:ncarcompilers/0.8.0:openmpi/4.1.5:netcdf/4.9.1"
export MODULEPATH=/glade/u/apps/casper/modules/environment

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/casper/23.04/spack/opt/spack/lmod/8.7.14/gcc/7.5.0
...
export LMOD_MODULERCFILE=/glade/work/csgteam/spack-deployments/casper/23.04/envs/public/util/hidden-modules
