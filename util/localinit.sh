# Location variables
export INSTALLPATH_ROOT=/glade/u/apps/casper/25.10-rocm/spack/opt/spack
export MODULEPATH_ROOT=/glade/u/apps/casper/modules

# Lmod configuration
export LMOD_SYSTEM_NAME=casper-rocm
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/25.10-rocm:gcc/14.3.0:ncarcompilers/1.1.0:rocm/6.4.3:openmpi/5.0.9:netcdf/4.9.3"
...
export LMOD_PACKAGE_PATH=/glade/u/apps/casper/25.10-rocm/envs/public/util
export LMOD_CONFIG_DIR=/glade/u/apps/casper/25.10-rocm/envs/public/util
export LMOD_AVAIL_STYLE=grouped:system

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/casper/25.10-rocm/spack/opt/spack/lmod/8.7.55/gcc/12.5.0/7u6s
...
export NCAR_OS_VERSION=`/usr/bin/lsb_release -rs`
...
export LMOD_MODULERCFILE=/glade/u/apps/casper/25.10-rocm/envs/public/util/hidden-modules
