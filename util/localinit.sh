...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/23.03:intel/2023.0.0:ncarcompilers/0.8.0:openmpi/4.1.5:netcdf/4.9.1"
export MODULEPATH=/glade/u/apps/casper/modules/environment

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/casper/23.03/spack/opt/spack/lmod/8.7.14/gcc/10.4.0
