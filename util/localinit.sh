...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/23.06:intel/2023.0.0:ncarcompilers/1.0.0:openmpi/4.1.5:netcdf/4.9.2"
export MODULEPATH=/glade/u/apps/casper/modules/environment

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/casper/23.06/spack/opt/spack/lmod/8.7.20/gcc/7.5.0/ffgp
...
export LMOD_MODULERCFILE=/glade/work/csgteam/spack-deployments/casper/23.06/envs/public/util/hidden-modules
