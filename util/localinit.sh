...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/24.12:intel/2024.2.1:ncarcompilers/1.0.0:openmpi/5.0.5:netcdf/4.9.2"
...
export LMOD_PACKAGE_PATH=/glade/u/apps/casper/24.12/envs/public/util
export LMOD_CONFIG_DIR=/glade/u/apps/casper/24.12/envs/public/util
export LMOD_AVAIL_STYLE=grouped:system

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/casper/24.12/spack/opt/spack/lmod/8.7.37/gcc/12.4.0/diu3
...
export LMOD_MODULERCFILE=/glade/u/apps/casper/24.12/envs/public/util/hidden-modules
