# Location variables
export INSTALLPATH_ROOT=/glade/u/apps/casper/25.10/spack/opt/spack
export MODULEPATH_ROOT=/glade/u/apps/casper/modules

# Lmod configuration
export LMOD_SYSTEM_NAME=casper
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/25.10:intel/2025.2.1:ncarcompilers/1.1.0:openmpi/5.0.8:netcdf/4.9.3"
...
export LMOD_PACKAGE_PATH=/glade/u/apps/casper/25.10/envs/public/util
export LMOD_CONFIG_DIR=/glade/u/apps/casper/25.10/envs/public/util
export LMOD_AVAIL_STYLE=grouped:system

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/casper/25.10/spack/opt/spack/lmod/8.7.55/gcc/12.5.0/qemb
...
export LMOD_MODULERCFILE=/glade/u/apps/casper/25.10/envs/public/util/hidden-modules
