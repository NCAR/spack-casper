...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/25.08-rocm:aocc/5.0.0:ncarcompilers/1.0.0:openmpi/5.0.8:netcdf/4.9.3"
...
export LMOD_PACKAGE_PATH=/glade/u/apps/casper/25.08-rocm/envs/public/util
export LMOD_CONFIG_DIR=/glade/u/apps/casper/25.08-rocm/envs/public/util
export LMOD_AVAIL_STYLE=grouped:system

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/casper/25.08-rocm/spack/opt/spack/lmod/8.7.2/gcc/12.5.0/wfd4
...
export LMOD_MODULERCFILE=/glade/u/apps/casper/25.08-rocm/envs/public/util/hidden-modules
